 ...
 * Class for game behaviors like generate pick check if pick is valid, who won, etc.
 */
...
public class RPSLSpock {
    ...
    /**
     * isValidPick
     * @param pick user input string and check if it is a valid input/choice
     * @return true or false depending on if the pick is valid
     */
    ...
    /**
     * generatePick
     * @return returns a randomly generated choice from one of the 5 options
     */
     ...
     * @param h_pick humans choice
     * @return returns if the computer won or not as a boolean
     */
